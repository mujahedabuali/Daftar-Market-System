...
class menuFrame(customtkinter.CTkFrame):
    def __init__(self, parent, page3, page4,page5,sold,dash,order,supliers,Xreturn,oblig,setting,record,logout):
        ...
        self.calc_button = customtkinter.CTkButton(self, corner_radius=0, height=40, border_spacing=10,font=customtkinter.CTkFont(size=16, weight="bold"),text="حسابات", image=self.statsIMG, compound="left",fg_color="transparent", text_color=("gray10", "gray90"), hover_color=("gray70", "gray30"), anchor="w", command=page3)
        self.calc_button.grid(row=9, column=0, sticky="ew")
...
class App(customtkinter.CTk):
    ...
    def select_frame_by_name(self, name):
        self.navigation_frame.calc_button.configure(fg_color=("gray75", "gray25") if name == "calc" else "transparent")
        ...
        if name == "calc":
            self.stat.grid(row=0, column=1, sticky="nsew")
    ...
    def login(self):
       ...
       self.stat = Stat(self,self.loginPage)
